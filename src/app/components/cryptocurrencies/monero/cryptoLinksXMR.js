...
export default class CryptoLinksXMR extends Component {
    render() {
        return (
                ...
                <div class="row">
                    ...
                    <div class="col-2">
                        <Link to="/ethereum" style={{ textDecoration: 'none' }}>
                            <div class="eth-notActiveLink"><i class="cf cf-eth"></i></div>
                        </Link>
                    </div>
                    <div class=" col-2">
                    ...
                    <div class="col-2">
                        <Link to="/monero" style={{ textDecoration: 'none' }}>
                            <div class="xmr-activeLink"><i class="cf cf-xmr"></i></div>
                        </Link>
                    </div>
                    <div class="col-2">
