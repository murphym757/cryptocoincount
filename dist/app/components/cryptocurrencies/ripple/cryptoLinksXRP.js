...
var CryptoLinksXRP = function (_Component) {
    _inherits(CryptoLinksXRP, _Component);

    function CryptoLinksXRP() {
        _classCallCheck(this, CryptoLinksXRP);

        return _possibleConstructorReturn(this, (CryptoLinksXRP.__proto__ || Object.getPrototypeOf(CryptoLinksXRP)).apply(this, arguments));
    }

    _createClass(CryptoLinksXRP, [{
        key: 'render',
    ...
    return CryptoLinksXRP;
}(_react.Component);

exports.default = CryptoLinksXRP;